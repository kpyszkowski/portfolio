...
const playgroundStyles = createStyles({
  slots: {
...
interface PlaygroundProps extends StylesProps<typeof playgroundStyles> {
  className?: string
...
export { Playground, playgroundStyles, type PlaygroundProps }
