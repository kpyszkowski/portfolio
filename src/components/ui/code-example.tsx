...
const codeExampleStyles = createStyles({
  slots: {
    container: 'group',
    content: 'pb-4',
    copyButton: [
...
interface CodeExampleProps extends StylesProps<typeof codeExampleStyles> {
  className?: string
...
const CodeExample = async (props: CodeExampleProps) => {
  ...
  const styles = codeExampleStyles()
...
export { CodeExample, codeExampleStyles, type CodeExampleProps }
