...
const writingIntroStyles = createStyles({
  slots: {
    container:
...
interface WritingIntroProps extends StylesProps<typeof writingIntroStyles> {
  className?: string
  publishedAt: Date
  title: string
  modifiedAt?: Date
...
function WritingIntro(props: WritingIntroProps) {
  ...
  const styles = writingIntroStyles()
...
export { WritingIntro, writingIntroStyles, type WritingIntroProps }
