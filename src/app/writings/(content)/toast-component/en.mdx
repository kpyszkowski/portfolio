...
imperative API which is ideal for toasts.

> [!insight]
>
> Imperative programming is a programming paradigm that focuses on describing
> how a program operates, using statements that change a program's state. It
> this particular case it means you call the function to trigger the toast which
> is uncommon in React where JSX is declarative by design.
